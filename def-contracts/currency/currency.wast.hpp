const char* const currency_wast = R"=====(
(module
 (type $FUNCSIG$v (func))
 ...
 (table 0 anyfunc)
 (memory $0 1)
 (data (i32.const 4) "\805\00\00")
 (data (i32.const 16) "issue\n\00")
 (data (i32.const 32) "transfer\n\00")
 (data (i32.const 48) "create\n\00")
 ...
 (data (i32.const 400) "invalid quantity\00")
 (data (i32.const 432) "must transfer positive quantity\00")
 (data (i32.const 464) "can only transfer to white listed accounts\00")
 (data (i32.const 512) "receiver requires whitelist by issuer\00")
 ...
 (data (i32.const 816) "account is frozen by issuer\00")
 (data (i32.const 848) "all transfers are frozen by issuer\00")
 (data (i32.const 896) "account is not white listed\00")
 (data (i32.const 928) "issuer may not recall token\00")
 (data (i32.const 960) "insufficient authority\00")
 (data (i32.const 992) "unable to find key\00")
 (data (i32.const 1024) "get\00")
 (data (i32.const 1040) "must issue positive quantity\00")
 ...
 (func $_ZN5eosio8currency2onERKNS0_5issueE (param $0 i32) (param $1 i32)
  ...
  (call $require_auth
   (i64.load offset=32
    (tee_local $2
     (call $_ZNK5eosio11multi_indexILy14289235522390851584ENS_8currency14currency_statsEJEE3getEy
      (i32.add
       (get_local $12)
       (i32.const 88)
      )
 ...
 (func $_ZNK5eosio11multi_indexILy14289235522390851584ENS_8currency14currency_statsEJEE3getEy (param $0 i32) (param $1 i64) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $_ZN5eosio8currency15inline_transferEyyNS_5assetENSt3__112basic_stringIcNS2_11char_traitsIcEENS2_9allocatorIcEEEEy (param $0 i32) (param $1 i64) (param $2 i64) (param $3 i32) (param $4 i32) (param $5 i64)
  ...
  (set_local $0
   (call $_ZN5eosio6actionC2INS_8currency8transferEEERKNS_16permission_levelEyyRKT_
    (i32.add
     (get_local $11)
     (i32.const 72)
    )
 ...
 (func $_ZN5eosio6actionC2INS_8currency8transferEEERKNS_16permission_levelEyyRKT_ (param $0 i32) (param $1 i32) (param $2 i64) (param $3 i64) (param $4 i32) (result i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
  (local $8 i32)
