(module
 ...
 (func $_ZN5eosio8multisig4execEyNS_4nameEy (type $FUNCSIG$vijjj) (param $0 i32) (param $1 i64) (param $2 i64) (param $3 i64)
  ...
  (drop
   (call $_ZN5eosiolsINS_10datastreamIPKcEEEERT_S6_RKNS_18transaction_headerE
    (i32.add
     (get_local $8)
     (i32.const 16)
    )
 ...
 (func $_ZN5eosiolsINS_10datastreamIPKcEEEERT_S6_RKNS_18transaction_headerE (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
