(module
 ...
 (data (i32.const 480) "identity does not exist\00")
 (data (i32.const 512) "certrow::type should be not longer than 32 bytes\00")
 (data (i32.const 576) "unexpected error in fixed_key constructor\00")
 ...
 (data (i32.const 736) "owner\00")
 (data (i32.const 752) "data size doesn\'t match account_name size\00")
