const char* const identity_test_wast = R"=====(
(module
 ...
 (data (i32.const 8944) "owner\00")
 (data (i32.const 8960) "unexpected error in fixed_key constructor\00")
 ...
 (data (i32.const 9104) "cannot modify objects in table of another contract\00")
 (data (i32.const 9168) "updater cannot change primary key when modifying an object\00")
 (data (i32.const 9232) "write\00")
 (data (i32.const 9248) "cannot increment end iterator\00")
 (data (i32.const 9280) "object passed to iterator_to is not in multi_index\00")
 (data (i32.const 9344) "error reading iterator\00")
 (data (i32.const 9376) "read\00")
 (data (i32.const 9392) "get\00")
 (data (i32.const 9408) "object passed to iterator_to is not in multi_index\00")
 (data (i32.const 9472) "error reading iterator\00")
 (data (i32.const 9504) "read\00")
